...
public final class TestJaxbBean extends MBeanJaxbBase<TestJaxbBean> implements IConfigFragment, Origin.Wise {
    ...
    public static final class Wrap {
        ...
        List<TestJaxbBean> mailBeans = Collections.EMPTY_LIST;
