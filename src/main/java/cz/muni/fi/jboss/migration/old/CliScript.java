...
public interface CliScript {
     ...
     * @throws cz.muni.fi.jboss.migration.ex.CliScriptException  if one of the required attributes is null or empty
     */
    ...
    /**
     * Method for generating CLI script for creating given resource-adapter
     *
